...
final class RuntimeHelper {
    ...
    static MemorySegment asArray(MemorySegment segment, MemoryLayout layout, int numElements, MemorySession session) {
         return MemorySegment.ofAddress(segment.address(), numElements * layout.byteSize(), session);
    }
